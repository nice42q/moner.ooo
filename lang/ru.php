...
$page_title = "Конвертация XMR в EUR/BTC/CHF/USD и многие другие"; // The browser tab title or search engine title
$meta_description = "Живой курс обмена Monero на многие различные валюты, бесплатно для всех."; // Search engine description / text
$meta_keywords = "Monero, XMR, фиат, стоимость, курс, живой, обмен, конвертация"; // Search engine keywords

$title_h1 = "конвертация в"; // ↓ XMR [...] ↓
