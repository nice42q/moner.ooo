...
$l_lang_meta         = "pt-br";
$l_rtl               = "false";
$l_page_title        = "Conversor de XMR para BRL/EUR/BTC/USD e muito mais";
$l_meta_description  = "Cotação em tempo real do Monero em várias moedas, gratuito para todos.";
...
$l_refresh_info_minute  = "Os valores são atualizados a cada minuto.";
$l_refresh_info_minutes = "Os valores são atualizados a cada %s minutos.";
$l_refresh_info_seconds = "Os valores são atualizados a cada %s segundos.";
...
$l_webserver_sponsor = "Hospedagem fornecida por";

$l_api_update        = $l_last_at . " <u title=\"$l_hr_min_sec\"><span id=\"lastUpdateDisplay\">00:00:00</span></u> (<span id=\"displayTimeZone\">horário local</span>).";
