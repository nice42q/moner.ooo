...
$meta_keywords = "Monero, XMR, fiduciario, valor, taxa, agora, cotacao, conversao"; // Search engine keywords

$title_h1 = "converter para"; // ↓ XMR [...] ↓
...
// Info Text
$info = "As cotações oferecidas neste site são apenas para fins informativos. Não há garantia que as cotações estejam precisas e estão sujeitas à mudanças sem aviso prévio. As cotações são atualizadas a cada 5 segundos. A última atualização foi em <u title='Hours:Minutes:Seconds (hh:mm:ss)'>".$time."</u>, horário europeu (Berlin). Os dados são providos pela <a class='text-white' href='https://www.coingecko.com/pt/moedas/monero' hreflang='pt' rel='external' target='_blank'>CoinGecko</a>.<br/><a target='_blank' href='https://kuno.anne.media/donate/onml/' rel='external' hreflang='en'><img loading='lazy' src='./img/kuno-monero-26x26.png' width='17' height='17' alt='Kuno - Moner.ooo donation page'></a>&nbsp;<a target='_blank' href='https://kuno.anne.media/' class='text-white' rel='external' hreflang='en'>Kuno – Faça vaquinhas com Monero</a> | <a class='text-white' href='https://github.com/nice42q/moner.ooo' hreflang='en' rel='external' target='_blank'>GitHub</a>";
