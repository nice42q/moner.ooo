...
$page_title = "XMR μετατροπή σε EUR/BTC/CHF/USD και πολλά άλλα";
// Search engine description / text
$meta_description = "Η ζωντανή ισοτιμία του Monero σε πολλά διαφορετικά νομίσματα, δωρεάν για όλους.";
// Search engine keywords
$meta_keywords = "Monero, XMR, fiat, αξία, ισοτιμία, ζωντανά, ανταλλαγή, μετατροπή";
// ↓ XMR [...] ↓
$title_h1 = "μετατροπή σε";
