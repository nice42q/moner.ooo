...
$lang_meta = "ja"; // https://www.w3schools.com/tags/ref_language_codes.asp

$page_title = "XMRをEUR/BTC/CHF/USDおよびその他多くの通貨に変換"; // The browser tab title or search engine title
$meta_description = "さまざまな通貨でのMoneroのリアルタイム為替レートを無料で提供します。"; // Search engine description / text
$meta_keywords = "Monero, XMR, フィアット, 価値, レート, リアルタイム, 為替, 変換"; // Search engine keywords
