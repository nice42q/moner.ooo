...
$moneroooTable = "الخدمة مقدمة من <a href=\"https://moner.ooo/\">Moner.ooo</a> ، البيانات مقدمة من <a href=\"https://www.coingecko.com/en/coins/monero\" hreflang=\"en\" rel=\"external\">CoinGecko</a>";
$unixTime = "وقت يونكس:";
// Info Text
$info = "أسعار الصرف على هذا الموقع هي لأغراض إعلامية فقط. لا نضمن دقتها، وهي عرضة للتغيير دون إشعار. يتم تحديث أسعار الصرف كل 5 ثوانٍ. آخر تحديث عند الساعة <u title=\"الساعات:الدقائق:الثواني (س س:د:ث)\">$time</u> ، أوروبا/برلين. البيانات مقدمة من <a class='text-white' href='https://www.coingecko.com/en/coins/monero' hreflang='en' rel='external' target='_blank'>CoinGecko</a> .<br/> <a target='_blank' href='https://kuno.anne.media/donate/onml/' rel='external' hreflang='en'><img loading='lazy' src='./img/kuno-monero-26x26.png' width='17' height='17' alt=\"كونو - صفحة التبرعات Moner.ooo\"></a> <a target='_blank' href='https://kuno.anne.media/' class='text-white' rel='external' hreflang='en'>Kuno – جمع التبرعات باستخدام Monero</a> | <a class='text-white' href='https://github.com/nice42q/moner.ooo' hreflang='en' rel='external' target='_blank'>GitHub</a> | <a style='text-decoration:none; font-weight:bold;' class='text-white' href='https://servers.guru/' hreflang='en' rel='external' target='_blank'>استضافة الويب مقدمة من <img loading='lazy' src='./img/servers-guru.svg' height='19' alt='Servers Guru' title=\"سيرفر جورو\" /></a>";
